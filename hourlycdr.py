...
class Call_Detail_Directory:
    ...
    def get_calls(
        ...
        while state == False:
            ...
            """&sortorder=asc&show_outbound=0&rows=500000&between={first_date}&between={last_date}&page=1' > './log/calls'
            """
...
def main():
    ...
    dates = getDates()
    test.get_calls("test",formatDate(dates[0]),formatDate(dates[1]))
    test.readCalls()
    count = Call_Counter()
